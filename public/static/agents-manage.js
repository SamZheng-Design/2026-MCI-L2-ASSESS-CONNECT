// ==========================================================
// 智能体管理中心 — agents-manage.js (v6)
//
// v6 核心改进：
//   1. 统一命名为「编辑方案」
//   2. 进入页面始终先看到方案仓库列表，不再自动跳转方案详情
//   3. 点击方案卡片 → 进入方案详情页（看智能体）
//   4. 方案详情页内编辑智能体
// ==========================================================
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 加载方案列表，始终展示仓库视图，不自动跳入任何方案详情
  loadProfiles();
});

// loadProfilesAndEnter 已废弃 — 始终从方案列表开始，不再自动跳转
// 保留此函数避免其他地方报错
